...
export const RELATED_LESSONS: RelatedLink[] = [
  ...
  { keywords: ['career', 'job', 'salary', 'hiring'], label: 'Robotics Career Paths', href: '/careers' },
  { keywords: ['drone', 'uav', 'quadcopter'], label: 'Drone News Coverage', href: '/news' },
  { keywords: ['humanoid', 'optimus', 'atlas', 'figure'], label: 'Humanoid Robotics News', href: '/news' },
  ...
  { keywords: ['kids', '8 years', '10 years', '12 years', 'class 6', 'class 7', 'class 8', 'class 9'], label: 'Start with Spark', href: '/academy/spark' },
  { keywords: ['daily life', 'every day', 'atm', 'roomba', 'invisible robots'], label: 'Robots in Daily Life', href: '/daily-life' },
  { keywords: ['history', 'unimate', 'first robot', '1961'], label: 'Robotics in the Atlas', href: '/atlas' },

...
seeAlso:
  ...
  - pid-controller
difficulty: 3
oneLiner: 'The concept concept: MPC predicts future robot behaviour over a horizon'
laymanExplanation: >-
...
whyItMatters: >-
  Without model predictive control (mpc) in robotics — complete guide, many
  concept systems in robotics simply couldn't work.

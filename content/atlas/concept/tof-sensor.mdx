...
oneLiner: >-
  The sensors concept: Time-of-Flight (ToF) sensors measure distance by timing
  reflected
laymanExplanation: >-
...
whyItMatters: >-
  Without time-of-flight sensor in robotics — complete guide | r2bot, many
  sensors systems in robotics simply couldn't work.

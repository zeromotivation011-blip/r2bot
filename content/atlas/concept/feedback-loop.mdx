...
seeAlso:
  ...
  - state-machine
difficulty: 3
oneLiner: 'The concept concept: A feedback loop continuously measures a robot''s output'
laymanExplanation: >-
...
whyItMatters: >-
  Without feedback loop in robotics — complete guide, many concept systems in

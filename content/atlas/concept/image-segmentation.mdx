...
oneLiner: 'The computer vision concept: Image segmentation labels every pixel in an image'
laymanExplanation: >-
...
whyItMatters: >-
  Without image segmentation in robotics — complete guide | r2bot, many computer

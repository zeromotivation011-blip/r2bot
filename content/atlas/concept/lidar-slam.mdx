...
oneLiner: 'The navigation localization concept: LIDAR SLAM uses laser-scan data to map an'
laymanExplanation: >-
...
whyItMatters: >-
  Without lidar slam in robotics — complete guide | r2bot, many navigation

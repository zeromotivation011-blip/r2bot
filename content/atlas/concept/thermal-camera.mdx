...
oneLiner: 'The sensors concept: Thermal cameras image infrared heat instead of visible'
laymanExplanation: >-
...
whyItMatters: >-
  Without thermal camera in robotics — complete guide | r2bot, many sensors

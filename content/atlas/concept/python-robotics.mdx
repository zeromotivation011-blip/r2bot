...
difficulty: 3
oneLiner: 'The concept concept: Python is the most popular language for robotics'
laymanExplanation: >-
...
whyItMatters: >-
  Without python for robotics — complete guide, many concept systems in robotics

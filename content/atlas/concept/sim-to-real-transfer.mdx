...
oneLiner: >-
  The ai machine learning concept: Sim-to-Real bridges robot policies trained in
  simulation to
laymanExplanation: >-
...
whyItMatters: >-
  Without sim-to-real transfer in robotics — complete guide | r2bot, many ai
  machine learning systems in robotics simply couldn't work.

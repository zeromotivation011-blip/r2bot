...
difficulty: 3
oneLiner: >-
  The robot concept: Spot is Boston Dynamics' four-legged industrial inspection
  robot
laymanExplanation: >-
  Spot is Boston Dynamics' four-legged industrial inspection robot — the yellow
...
whyItMatters: >-
  Without spot (boston dynamics), many robot systems in robotics simply couldn't
  work.
